...
(defun new-classes.unserialize-all ()
  (let ((t-storage))
    ...
    (let ((*global-storage* (make-instance 'global-storage)))
      (unserialize-from-file (backup.last-group-backup-pathname) (make-instance 'group))
      (unserialize-from-file (backup.last-product-backup-pathname) (make-instance 'product))
