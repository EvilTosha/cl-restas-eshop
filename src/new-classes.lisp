...
(defmacro new-classes.make-class-and-methods (name list-fields)
  `(values
    (new-classes.make-class ,name ,list-fields)
    (new-classes.make-view-method ,name ,list-fields)
    (new-classes.make-edit-method ,name ,list-fields)
    (new-classes.make-unserialize-method ,name ,list-fields)
    (backup.make-serialize-method ,name ,list-fields)))
