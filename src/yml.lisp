    ...
    (when parent
      ...
      (if (or (equal key "krupnaya-bitivaya-tehnika")
          ...
          (if (or
                  ...
                  ;; (equal key "britvy")
                  ;; (equal key "utyugi")
                  ;; (equal key "tostery-i-friturnicy")
                  ;; (equal key "shveinye-mashiny")
                  ;; (equal key "pylesosy")
                  ;; (equal key "parovarki-i-aerogrili")
                  ;; (equal key "mikrovolnovye-pechi-i-hlebopechki")
                  ;; (equal key "kuhonnye-kombainy-i-myasorubki")
                  ;; (equal key "kuhonnie-vesy")
                  ;; (equal key "kofevarki-i-kofemolki")
                  ;; (equal key "elektrochainiki-i-termopoty")
                  ;; (equal key "blendery-i-mixery")
...
(defun yml.get-product-delivery-price2 (product)
  (let ((parent (if product (new-classes.parent product)))
        (key)
        (result 300))
    (when parent
